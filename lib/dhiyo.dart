...
class _DhiyoState extends State<Dhiyo> {
  ...
  List<String> jobCategories = [
    "Trek Breast Cancer Awarness",
    "Zumbathon for Breast Cancer",
    "Celebrate your Princess",
    "Wheel works breast cancer",
    "Breast Cancer Awarness",
    "Pink Awarness Walk"
  ];

  Map jobCatToIcon = {
    "Trek Breast Cancer Awarness": Image.network('https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQQv0SXyhqdHpQn9a769w6bnW1c81r3APg5a6F8eMKuqQhwLS9e&usqp=CAU',
    height: 900,
    ),
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            height: 100,
            width: 130,
            child: Text('Dolore qui mollit cupidatat deserunt sint fugiat sit anim ut ad.'),
              //elevation: 10,
          )
        ],
      ),
      ...
      onTap: (){
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(job.location),
            Text(/*makeSalaryToK(job.salary)*/'Metastatic Breast Cancer', style: GoogleFonts.montserrat(
                                color: Colors.black,
                                fontSize: 12,
                                fontWeight: FontWeight.w500,
                              )),
  ...
  List<Widget> getRecentJobs() {
   ...
   List<Job> findJobs() {
    List<Job> jobs = [];
    for (int i = 0; i < 5; i++) {
      jobs.add( Job("English ", "Miriam Trejo", 20, "Age: 51", "Canada", AssetImage("lib/assets/person.png")));
      jobs.add( Job("English ", "Ria Sharma", 20, "Age: 51", "USA", AssetImage("lib/assets/person.png")));
    }
    return jobs;
  }
